    ...
    <div class="grid gap-2 md:grid-cols-3">
      ...
      >
        <span class="flex flex-col items-start">
          ...
          <span class="text-xs opacity-80 break-words leading-snug"
            >Write monitoring + task write preset</span
          >
        </span>
      </Button>
      ...
      >
        <span class="flex flex-col items-start">
          ...
          <span class="text-xs opacity-80 break-words leading-snug"
            >Read-only monitoring preset</span
          >
        </span>
      </Button>
      ...
      >
        <span class="flex flex-col items-start">
          ...
          <span class="text-xs opacity-80 break-words leading-snug"
            >Manually adjust all permissions</span
          >
        </span>
      </Button>
    </div>
